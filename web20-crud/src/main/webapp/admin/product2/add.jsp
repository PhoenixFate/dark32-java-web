...
<HTML>
	...
	<body>
		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminAddProduct" method="post" >
			&nbsp;
			<table cellSpacing="1" cellPadding="5" width="100%" alig							<%--<option value="">大型电器</option>--%>
				   n="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				<tr>
