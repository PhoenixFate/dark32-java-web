...
<div class="slide_show" id="slide_show">
	<div class="indexW">
      <div id="index_slide" class="slide_wrap">
		<ol>
			<c:forEach items="${bigAdsList}" var="node" varStatus="status">
			<li>
			  <a name="sfbest_hp_hp_focus_${status.index}" class="fore_pic trackref" href="${node.url}" target="_blank">
				<img id="lunbo_${status.index}" alt="${node.title}"	src="${pageContext.request.contextPath}/${node.pic}">
			  </a>
			</li>
			</c:forEach>
...
<%--				<img id="lunbo_1" alt="8.30-9.5 月饼"	src="${pageContext.request.contextPath}/images/html/aa472cb9f9624d22d1fcfd1c4dffbe42.jpg">--%>
<%--			  </a>--%>
<%--			</li>--%>
...
<%--					src="${pageContext.request.contextPath}/images/html/516e4d058d1d65a3506e179642297b2d.jpg">--%>
<%--			</a></li>--%>
...
<%--					src="${pageContext.request.contextPath}/images/html/e886f76e03f7a3596033eb34ca362339.jpg">--%>
<%--			</a></li>--%>
...
<%--					src="${pageContext.request.contextPath}/images/html/757e35fab995b43c23b4396dc3ba4269.jpg">--%>
<%--			</a></li>--%>
...
<%--					src="${pageContext.request.contextPath}/images/html/1748dcf682d7f595012e4309695d71d9.jpg">--%>
<%--			</a></li>--%>
...
<%--					src="${pageContext.request.contextPath}/images/html/de66a063548629c8d4e639523d8c9c6e.jpg">--%>
<%--			</a></li>--%>
...
<%--					src="${pageContext.request.contextPath}/images/html/600c425e04b41f49e451d2fdbafb6e45.jpg">--%>
<%--			</a></li>--%>
...
<%--					src="${pageContext.request.contextPath}/images/html/4dd7317569a06a451c1fe7762d6bf928.jpg">--%>
<%--			</a></li>--%>
		</ol>
	</div>
     <div class="rSide">
      ...
      <ul class="none" id="lunboNum">
      			<c:forEach items="${bigAdsList}" varStatus="status">
...
<div class="indexW mt1">
				...
				<ul class="bbig" id="bigPerfect">
					<li class="price_list0" goods="215383" eid="b_215383_0"
						...
						title="红肉火龙果1000g（2个装）" target="_blank"><img class="lazy"
							src="${pageContext.request.contextPath}/images/html/95256f5b2857ec28914f631532508d76.jpg"
					...
					<li class="price_list0" goods="57111" eid="b_57111_0"
						...
						title="湾仔码头 玉米蔬菜猪肉手工水饺 720g" target="_blank"><img class="lazy"
							src="${pageContext.request.contextPath}/images/html/49111b8189bf71370cdb145f8fdb1195.jpg"
							style="display: inline;"></a>
					<div class="gBtn p-btn bbtn" style="top: 260px;">
							<a pid="57111"
								href="javascript:void(0)" indexflag="1">加入购物车</a>
					...
					<li class="price_list0" goods="5536" eid="b_5536_0"
						...
						title="汾酒 53°20年青花瓷  500ml" target="_blank"><img class="lazy"
							...
							src="${pageContext.request.contextPath}/images/html/cf33d7d36f1128577782ded21fe812a9.jpg"
							style="display: inline;"></a>
					...
					<li class="price_list0" goods="12045" eid="b_12045_0"
						...
						title="佳沛  新西兰阳光金果奇异果6粒" target="_blank"><img class="lazy"
							alt="佳沛  新西兰阳光金果奇异果6粒"
							src="${pageContext.request.contextPath}/images/html/2a3ba6ffb33d8fca0dc848f94e3d99d8.jpg"
							style="display: inline;"></a>
					<div class="gBtn p-btn bbtn">
							<a pid="12045"
								href="javascript:void(0)" indexflag="1">加入购物车</a>
				...
				<ul class="bsmall" id="smallPerfect">
					<li class="price_list0" goods="37194" eid="b_37194_1"
						...
						title="精气神 山黑猪猪蹄 320g" target="_blank"><img class="lazy"
							src="${pageContext.request.contextPath}/images/html/c3449a684bebe21f5b6c6c79e46791ff.jpg"
							style="display: inline;"></a>
					...
					<li class="price_list0" goods="219085" eid="b_219085_1"
						...
						title="八马茶业 福鼎白茶(白牡丹）62.5g*2" target="_blank"><img
							class="lazy"
							src="${pageContext.request.contextPath}/images/html/042cc65a4fb9899878f2f37235ca1793.jpg"
							style="display: inline;"></a>
					<div class="gBtn p-btn bbtn" style="top: 210px;">
							<a pid="219085"
					...
					<li class="price_list0" goods="55213" eid="b_55213_1"
						...
						title="爱之湾 桃红莫斯卡托甜起泡酒 750ml" target="_blank">
                            <img class="lazy"
							data="/images/goods/c11e0d59289782b09ea1cbcb98070017.jpg"
							alt="爱之湾 桃红莫斯卡托甜起泡酒 750ml"
							src="${pageContext.request.contextPath}/images/goods/c11e0d59289782b09ea1cbcb98070017.jpg"
					...
					<li class="price_list0" goods="167461" eid="b_167461_1"
						...
						title="北纯  有机绿豆 1kg" target="_blank"><img class="lazy"
							...
							alt="北纯  有机绿豆 1kg"
							src="${pageContext.request.contextPath}/images/goods/7cc96c14e10f6ed8db28b4b1efdfdb07.jpg"
							style="display: inline;"></a>
					<div class="gBtn p-btn bbtn">
							<a pid="167461"
	...
	<div class="rSide1">
    	...
    	<div class="rImg2">
      	<a name="sfbest_hp_hp_news_right-ad" class="trackref" href="${pageContext.request.contextPath}/html/activity/1472464260.html" target="_blank"><img salt="9.2-9.5" src="${pageContext.request.contextPath}/images/goods/751d2091c008c2a49c1934545730f041.jpg"></a>
   		</div>
...
<div class="indexW mt2 full_ad" style="width:1190px;padding-left:10px;"><a name="sfbest_hp_hp_banner_1" class="trackref" href="/html/activity/1472461333.html" target="_blank"><img alt="8.30-9.5" class="lazy"
 src="${pageContext.request.contextPath}/images/goods/8f42d6d2deead3da7d50c8a702a3c939.jpg" style="display: inline;"></a>
	 </div>
<div class="indexW mt2 ie6 fresh">
	...
	<ul class="mTitle">
		...
		<img alt="8.30-9.5" class="lazy" src="${pageContext.request.contextPath}/images/goods/26336113289bf7273823080488a9d200.jpg" style="display: inline;"></a></div>
	  </div>
  <div class="sfRight">
      <div class="subCont">
					...
					<li class="price_list1" eid="l_218031_7_297" goods="218031"
						id="cx_l_218031_7_297"><div class="pImg">
							<a
								...
								alt="泰国金柚700-1200g"
								src="${pageContext.request.contextPath}/images/goods/160x160-1.jpg"
					...
					<li class="price_list1" eid="l_218155_7_297" goods="218155"
						id="cx_l_218155_7_297"><div class="pImg">
							<a
								...
								src="${pageContext.request.contextPath}/images/goods/160x160-2.jpg"
								style="display: block;"></a>
							<div class="gBtn p-btn">
								<a pid="218155"
									data_url="/images/goods/160x160.jpg"
					...
					<li class="price_list1" eid="l_236853_7_297" goods="236853"
						id="cx_l_236853_7_297"><div class="pImg">
							<a
								...
								data="/images/goods/160x160.jpg"
								alt="一点红冬枣1000g"
								src="${pageContext.request.contextPath}/images/goods/160x160-3.jpg"
								style="display: block;"></a>
							<div class="gBtn p-btn">
								<a pid="236853"
									data_url="/images/goods/160x160.jpg"
					...
					<li class="price_list1" eid="l_218955_7_297" goods="218955"
						id="cx_l_218955_7_297"><div class="pImg">
							<a
								...
								data="/images/goods/160x160.jpg"
								alt="墨西哥牛油果420g（3个装）"
								src="${pageContext.request.contextPath}/images/goods/160x160-4.jpg"
								style="display: block;"></a>
							<div class="gBtn p-btn">
								<a pid="218955"
									data_url="/images/goods/160x160.jpg"
					...
					<li class="price_list1" eid="l_236863_7_297" goods="236863"
						id="cx_l_236863_7_297"><div class="pImg">
							<a
								...
								src="${pageContext.request.contextPath}/images/goods/160x160-5.jpg"
								style="display: block;"></a>
							<div class="gBtn p-btn">
								<a pid="236863"
									data_url="/images/goods/160x160.jpg"
					...
					<li class="price_list1" eid="l_236871_7_297" goods="236871"
						id="cx_l_236871_7_297"><div class="pImg">
							<a
								...
								data="/images/goods/160x160.jpg"
								alt="国产西梅1000g"
								src="${pageContext.request.contextPath}/images/goods/160x160-6.jpg"
								style="display: block;"></a>
							<div class="gBtn p-btn">
								<a pid="236871"
									data_url="/images/goods/160x160.jpg"
					...
					<li class="price_list1" eid="l_218073_7_297" goods="218073"
						id="cx_l_218073_7_297"><div class="pImg">
							<a
								...
								src="${pageContext.request.contextPath}/images/goods/160x160-7.jpg"
								style="display: block;"></a>
							<div class="gBtn p-btn">
								<a pid="218073"
									data_url="/images/goods/160x160.jpg"
					...
					<li class="price_list1" eid="l_215405_7_297" goods="215405"
						id="cx_l_215405_7_297"><div class="pImg">
							<a
								...
								data="/images/goods/160x160.jpg"
								alt="皇冠蜜梨1000g（4个装）"
								src="${pageContext.request.contextPath}/images/goods/160x160-8.jpg"
								style="display: block;"></a>
							<div class="gBtn p-btn">
								<a pid="215405"
									data_url="/images/goods/160x160.jpg"
