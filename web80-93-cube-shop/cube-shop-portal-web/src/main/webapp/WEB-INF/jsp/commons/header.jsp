...
<div id="header">
  <div class="header_inner">
    <div class="logo">
		...
		<a name="sfbest_hp_hp_head_logo" href="${portalAddress}" class="trackref logoleft">
		</a>
		<div class="logo-text">
    ...
    <div class="search">
      <form action="${searchAddress}/search/item.html" id="searchForm" name="query" method="GET">
    ...
    <div class="shopingcar" id="topCart">
      <s class="setCart"></s><a href="${cartAddress}/cart/cart.html" class="t" rel="nofollow">我的购物车</a><b id="cartNum">0</b>
