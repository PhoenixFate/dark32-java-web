...
<!-- header -->
<div class="header">
    <a href="${portalAddress}"><img src="${pageContext.request.contextPath}/images/logo.png"
...
<div class="login_main clear">
    <div class="pic">
        <a href="http://www.e3mall.cn/html/activity/1472720729.html" target="_blank"><img
                src="${pageContext.request.contextPath}/images/06f42c372620f92b40da77a8b23cdf7f.png"></a>
    </div>
    <!-- login -->
    <div class="login">
        <div class="login_header">
            <span>您还未登录</span>
            <a href="${pageContext.request.contextPath}/user/register/page">免费注册</a>
        </div>
