...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/order.css?v=20160713">
...
<script src="${pageContext.request.contextPath}/js/jquery.region.js?v=20160713" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/js/order.js?v=20160713" type="text/javascript"></script>
</head>	
<body id="mainframe">
<jsp:include page="commons/header.jsp" />
<div class="orderMain">
<form id="orderForm" class="hide" action="${pageContext.request.contextPath}/order/create.html" method="post">
