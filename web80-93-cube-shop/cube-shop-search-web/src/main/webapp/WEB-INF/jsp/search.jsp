            ...
            <ul class="list-all">
                <c:forEach items="${itemList }" var="item">
                    <li>
                        <div class="l-wrap">
                            <div class="pic">
                                <a class="trackref" href="${itemAddress}/item/${item.id}.html" title="" target="_blank">
                            ...
                            <div class="title-a">
                                <a class="trackref presaleSign_225865" href="${itemAddress}/item/${item.id}.html"
                                   target="_blank">${item.title }</a>
                            </div>
                            <div class="title-b" style=""><a class="trackref" href="${itemAddress}/item/${item.id}.html"
        ...
        <div class="catlist" id="cateall">
            ...
            <div class="cm">
                <div class="catitem" style="border-top-width: 0px;"><h3><b></b>
                    <a href="/productlist/search/?categoryId=8&amp;keyword=%E6%9C%88%E9%A5%BC&amp;o=saleNum%3Adesc"
