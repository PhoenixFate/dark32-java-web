...
<div id="footer">
    ...
    <div class="foot">
        <div class="pageFooter">
            ...
            <div class="left">
                <ul class="f_ios">
                    <li><a href="${portalAddress}" target="_blank">手机客户端</a></li>
                    <li><span></span></li>
                </ul>
                <ul class="f_wx">
                    <li>官方微信</li>
        ...
        <div class="bottom">
            <div class="bottom_kx">
                ...
                <a id="cnnic"
                   ...
                   rel="nofollow" target="_blank"><img onclick="CNNIC_change('cnnic')"
                                                       src="${pageContext.request.contextPath}/images/kxicon.jpg"
                                                       border="0"></a>
            ...
            <div class="bottom_sm"><a id="_pingansec_bottomimagesmall_shiming"
                                      ...
                                      target="_blank"><img
                    src="${pageContext.request.contextPath}/images/bottom_sm.png"></a></div>
