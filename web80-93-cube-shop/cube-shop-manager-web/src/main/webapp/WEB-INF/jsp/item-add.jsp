...
<script type="text/javascript">
	...
	function submitForm(){
		...
		*/
		...
		var d = {};
		var t = $('#itemAddForm').serializeArray();
		$.each(t, function () {
		...
		//$.post 提交： 表单格式是 application/x-www-form-urlencoded;
		// 后端controller 对应的 不需要@RequestBody
		...
		//$.ajax 提交：设置了contentType: 'application/json'   表单格式是 application/json;
		// 后端controller 对应的 需要@RequestBody
		// $.ajax({
		// 	url: "./item/save",
		// 	method: 'post',
		// 	contentType: 'application/json',
		// 	data: JSON.stringify(d), // 以json字符串方式传递
