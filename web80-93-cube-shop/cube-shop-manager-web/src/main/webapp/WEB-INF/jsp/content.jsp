...
<div class="easyui-panel" title="Nested Panel" data-options="width:'100%',minHeight:500,noheader:true,border:false" style="padding:10px;">
    <div class="easyui-layout" data-options="fit:true">
        ...
        <div data-options="region:'center'" style="padding:5px">
            <table class="easyui-datagrid" id="contentList" data-options="toolbar:contentListToolbar,singleSelect:false,collapsible:true,pagination:true,method:'get',pageSize:20,url:'${pageContext.request.contextPath}/content/list',queryParams:{categoryId:0}">
		    <thead>
		        <tr>
...
var contentListToolbar = [{
    ...
    handler:function(){
    	...
    	// 选择的是父节点
    	if(!$("#contentCategoryTree").tree("isLeaf",node.target)){
			$.messager.alert('提示','请选择一个叶子节点!');
			return ;
		}
    	E3.createWindow({
