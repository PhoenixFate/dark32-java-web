...
<head>
    ...
    <script src="${pageContext.request.contextPath}/js/cloud-zoom.1.0.2.min.js?v=20160713"
            ...
            <div class="pItemsMain">
                ...
                <div class="pItemsPrice" id="price-sf">
                    <div class="priceBox">
                        ...
                        <strong class="price"><fmt:formatNumber groupingUsed="false" maxFractionDigits="2"
                                                                minFractionDigits="2"
                                                                value="${itemDto.item.price / 100 }"/></strong>
                    </div>
                    <div class="boxWb"></div>
                ...
                <div class="pItemsChoose">
                    ...
                    <div class="chooseBtns" id="buy-btn-sf">
                        ...
                        <input type="hidden" value="${cartAddress}" id="cartAddress"/>
                        ...
                        <div class="phone_client phone_border">
                            <div id="download_client">扫描下载客户端<br><em>先摇券 后买单</em></div>
                            <!--手机二维码显示层-->
                    ...
                    <div class="chooseBtns" id="buy-nogood-sf" style="display:none">
                        ...
                        <div class="phone_client phone_border">
                            <div id="download_client2">扫描下载客户端<br><em>先摇券 后买单</em></div>
                            <!--手机二维码显示层-->
                            <div class="phone_clientCode" style="display:none;">
                                <a href="javascript:void(0)" class="ac_phoneClose" title="关闭"></a>
        ...
        <div class="pItemsSide">
                ...
                <div class="points">
                    <ul id="points-sf">
                        ...
                        <li class="has_poptip attr3">
                            <img src="${pageContext.request.contextPath}/images/productattr3.png">
                        </li>
            ...
            <div class="pcommdetail">
                <dl class="prate">
                    <dt>好评度：</dt>
                    <dd>
                        <div class="dd"><span id="positive-sf" style="width: 100%;height: 100%"></span></div>
                ...
                <ul class="l-buy" id="buyrebuy-sf">
                    <li>
                        <div class="p-img"><a target="_blank" href="#"><img
                                src="${pageContext.request.contextPath}/images/small_1800005691_1_1_1.jpg"></a></div>
