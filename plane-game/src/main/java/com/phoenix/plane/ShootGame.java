...
public class ShootGame extends JPanel {
    ...
    static {
        try {
            background = ImageIO.read(ShootGame.class.getResourceAsStream("/image/background.png"));
            start = ImageIO.read(ShootGame.class.getResourceAsStream("/image/start.png"));
            airplane = ImageIO.read(ShootGame.class.getResourceAsStream("/image/airplane.png"));
            bee = ImageIO.read(ShootGame.class.getResourceAsStream("/image/bee.png"));
            bullet = ImageIO.read(ShootGame.class.getResourceAsStream("/image/bullet.png"));
            hero0 = ImageIO.read(ShootGame.class.getResourceAsStream("/image/hero0.png"));
            hero1 = ImageIO.read(ShootGame.class.getResourceAsStream("/image/hero1.png"));
            pause = ImageIO.read(ShootGame.class.getResourceAsStream("/image/pause.png"));
            gameover = ImageIO.read(ShootGame.class.getResourceAsStream("/image/gameover.png"));
