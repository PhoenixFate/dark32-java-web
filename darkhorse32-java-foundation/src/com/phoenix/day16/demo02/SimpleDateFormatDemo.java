package com.phoenix.day16.demo02;
...
public class SimpleDateFormatDemo {
	 ...
	 * 2.SimpleDateFormat调用方法format对日期进行格式化 String format(Date date) 传递日期对象,返回字符串
	 * 日期模式: yyyy 年份 MM 月份 dd 月中的天数 HH 0-23小时 mm 小时中的分钟 ss 秒 yyyy年MM月dd日 HH点mm分钟ss秒
	 * 汉字修改,: - 字母表示的每个字段不可以随便写
	 */
