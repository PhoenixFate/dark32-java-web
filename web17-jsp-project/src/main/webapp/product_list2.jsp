...
<body>
	...
	<div class="row" style="width: 1210px; margin: 0 auto;">
		...
		<%
			List<Product> productList2 = (List<Product>) request.getAttribute("productList2");
			if(productList2!=null) {
				for(Product product:productList2){
					out.write("<div class=\"col-md-2\" style='height:250px'>");
					out.write("<a href=\"product_info.htm\"> ");
					out.write("<img src=\""+product.getPimage()+"\" width=\"170px\" height=\"170px\" style=\"display: inline-block;\" >");
					out.write("</a>");
					out.write("<p>");
