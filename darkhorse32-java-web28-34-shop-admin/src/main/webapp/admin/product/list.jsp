            ...
            <td class="ta_01" align="center" bgColor="#f5fafe">
                <table cellspacing="0" cellpadding="1" rules="all"
                    ...
                    <tr style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #afd1f3">
                        ...
                        <td align="center" width="17%">商品市场价</td>
                        <td align="center" width="17%">商品售价</td>
                    ...
                    <c:forEach items="${pageBean.list}" var="product" varStatus="vs">
                        <tr onmouseover="this.style.backgroundColor = 'white'"
                            ...
                            <td align="center" style="HEIGHT: 22px">
                                <a href="${ pageContext.request.contextPath }/productServlet?method=addProductUI">
                                    <img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0"
                                         style="CURSOR: hand">
                                </a>
                            </td>
                            <td align="center" style="HEIGHT: 22px">
                                <a href="${ pageContext.request.contextPath }/productServlet?method=deleteProduct&pid=${product.pid}">
...
<div style="width: 380px; margin: 50px auto 0;">
    <ul class="pagination" style="text-align: center; margin-top: 10px;">
        ...
        <c:if test="${pageBean.currentPage>1}">
            <li>
                <a href="${pageContext.request.contextPath}/productServlet?method=listByPage&pageNumber=${pageBean.currentPage-1}" aria-label="Previous">
                    <span aria-hidden="true">&laquo;</span>
                </a>
            </li>
        </c:if>
        ...
        <c:forEach begin="1" end="${pageBean.totalPage}" var="pageIndex">
            <c:if test="${pageBean.currentPage==pageIndex}">
                <li class="active">
                    <a href="${pageContext.request.contextPath}/productServlet?method=listByPage&pageNumber=${pageIndex}">${pageIndex}</a>
                </li>
            </c:if>
            <c:if test="${pageBean.currentPage!=pageIndex}">
                <li >
        ...
        <c:if test="${pageBean.currentPage<pageBean.totalPage}">
            <li>
                <a href="${pageContext.request.contextPath}/productServlet?method=listByPage&pageNumber=${pageBean.currentPage+1}" aria-label="Next">
