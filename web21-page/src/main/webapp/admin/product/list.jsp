...
<body>
<br>
<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/searchProduct" method="post">
    ...
    <input type="submit" name="explore" value="搜索">
                ...
                <c:forEach items="${productList}" var="product" varStatus="vs">
                    <tr onmouseover="this.style.backgroundColor = 'white'"
                        ...
                        <td align="center" style="HEIGHT: 22px">
                            <a
                                    href="${ pageContext.request.contextPath }/showProduct?pid=${product.pid}">
                                <img
                                        src="${pageContext.request.contextPath}/images/i_edit.gif"
                                        border="0" style="CURSOR: hand">}
                            </a></td>

                        <td align="center" style="HEIGHT: 22px"><a href="javascript:void(0);"
